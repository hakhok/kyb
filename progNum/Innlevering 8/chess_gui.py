...
png = {
    ...
    "_": b'',
    " ": b''
}
...
def gui_main():
        ...
        for j, piece in enumerate(row):
            if piece:
                new_column = sg.Button(
                    image_data=png[piece], size=(3, 2), button_color = ('black', 'white'), key=f'{i}{j}'
                    )
            else:
                new_column = sg.Button(
                    image_data=png[" "], size=(3, 2), button_color = ('white', 'white'), key=f'{i}{j}'
                    )
    ...
    while True:
        ...
        if event in (sg.WINDOW_CLOSED, "Exit"):
            break
        if winner:
            window['last_move'].update(f"{player_color[player*-1]} won!")
            window['turn'].update(f"{player_color[player*-1]} won!")
        else:
            for i, row in enumerate(board):
                for j, piece in enumerate(row):
                    if event == f'{i}{j}':
                        if pice_to_move is None:
                            ...
                            window[f'{where_to_move[0]}{where_to_move[1]}'].update(image_data=png[piece], button_color = ('white'))
                            window[f'{pice_to_move[0]}{pice_to_move[1]}'].update(image_data=png[" "], button_color = ('white'))
                            for m in legal_moves:
                                if m != where_to_move:
                                        window[f'{m[0]}{m[1]}'].update(button_color=('white'))
                            try:
                            ...
                            for m in legal_moves:
                                if m != where_to_move:
                                    if get_piece(m) is not None and get_piece(m).islower():
                                        window[f'{m[0]}{m[1]}'].update(image_data=png[piece])
                                    else:
                                        window[f'{m[0]}{m[1]}'].update(button_color=('white'))
                            try:
                                last_pos_str = "Last move: "+f"{pos_to_coor[0][pice_to_move[1]]}{pos_to_coor[1][pice_to_move[0]]}"+" to "+f"{pos_to_coor[0][where_to_move[1]]}{pos_to_coor[1][where_to_move[0]]}"
