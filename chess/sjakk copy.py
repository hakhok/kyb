            ...
            if images:
                if piece:
                    new_column = sg.Button(
                        image_data=png[piece], size=(3, 2), key=f'{i}{j}', button_color = ('light blue')
                        )
                else:
                    new_column = sg.Button(
                        image_data=png[" "], size=(3, 2), key=f'{i}{j}'
                        )
            else:
                if piece:
                    new_column = sg.Button(
                        piece, size=(3, 2), key=f'{i}{j}'
                        )
                else:
                    new_column = sg.Button(
                        " ", size=(3, 2), key=f'{i}{j}'
            ...
            for j, piece in enumerate(row):
                if event == f'{i}{j}':
                    if pice_to_move is None:
                        ...
                        window[f'{where_to_move[0]}{where_to_move[1]}'].update(image_data=png[piece], button_color = ('light blue'))
